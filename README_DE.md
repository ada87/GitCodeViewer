...
[English](./README.md) | [简体中文](./README_ZH.md) | Deutsch | [Español](./README_ES.md) | [Français](./README_FR.md) | [हिन्दी](./README_HI.md) | [日本語](./README_JA.md) | [한국어](./README_KO.md) | [Português (Brasil)](./README_PT_BR.md) | [Bahasa Indonesia](./README_ID.md) | [Türkçe](./README_TR.md)
...
📱 **In der App ansehen?** Tippen Sie auf die Dateien unten, um Syntax-Hervorhebung und Rendering sofort zu testen.

> **Wie bekomme ich dieses Repo?**
> Suchen Sie in der App nach `GitCodeViewer`, oder tippen Sie auf **+** -> **Klonen** und geben Sie ein:

...
GitCode Viewer आपके कंप्यूटर का Git और कोड पढ़ने का अनुभव फ़ोन और टैबलेट पर लाता है — कोड और दस्तावेज़ कहीं भी पढ़ें।

आपकी रिपॉज़िटरी ही आपका नॉलेज बेस है। बिल्ट-इन AI असिस्टेंट रिपॉज़िटरी खोजने, बग पकड़ने, कोड समझाने, दस्तावेज़ सारांशित करने, कमिट लॉग देखने, अनुवाद करने आदि में आपकी मदद करता है।

## विशेषताएं

- 🤖 **स्मार्ट:** प्रमुख और कस्टम AI मॉडल प्रोवाइडर सपोर्टेड, OpenAI और Anthropic फ़ॉर्मेट API से संगत।
- 🌿 **सहज:** Clone / Branch / Log / Diff — कंप्यूटर जैसी ही सहजता।
- 🎨 **कोड:** 30+ भाषाओं के लिए सिंटैक्स हाइलाइटिंग (Java / Python / JavaScript आदि), कोड आउटलाइन और सिंबल नेविगेशन के साथ।
- 📚 **दस्तावेज़:** Markdown / Mermaid / Jupyter / Office / PDF तुरंत खोलें।
- 🔎 **खोजें:** GitHub ट्रेंडिंग और सर्च बिल्ट-इन, लोकप्रिय प्रोजेक्ट तुरंत खोजें।
- 📁 **प्रबंधन:** GitHub / GitLab / Bitbucket आदि और सेल्फ़-होस्टेड प्राइवेट रिपॉज़िटरी, SSH / PAT से सुरक्षित एक्सेस।
- 🧩 **आसान:** ऑफ़लाइन पढ़ें, बिना विज्ञापन, तुरंत शुरू करें।

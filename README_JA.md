...
[English](./README.md) | [简体中文](./README_ZH.md) | [Deutsch](./README_DE.md) | [Español](./README_ES.md) | [Français](./README_FR.md) | [हिन्दी](./README_HI.md) | 日本語 | [한국어](./README_KO.md) | [Português (Brasil)](./README_PT_BR.md) | [Bahasa Indonesia](./README_ID.md) | [Türkçe](./README_TR.md)
...
📱 **アプリで閲覧中ですか？** 以下のファイルをタップして、シンタックスハイライトとレンダリング機能をすぐにプレビューできます。
